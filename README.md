...
* Для работы уведомлений о недоступности майнеров необходимо, чтобы было запущена программа и открыто приложение в браузере
...
* Нажмите на чекбокса для включения уведомлений
* При включении уведомлений происходит проверка доступности бота
* Если не получилось соединиться с ботом, то высветится уведомление об этом
* Устраните проблемы, указанные в уведомлении
