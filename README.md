...
* Перед началом настройки уведомлений необходимо создать бота в Telegram
    ...
    * Отпрате ему команду <li>/newbot</li>
    * Далее необходимо указать отображаемое имя бота
    * После нужно указать <li>username</li> бота, которое должно заканчиваться <li>bot</li>
...
* Для того, чтобы бот мог отпралять вам сообщения необходимо найти бота по <li>username</li> и написать ему команду <li>/start</li>

#### Включение уведомлений

* Откройте панель Настройки
* Укажите токен от созданного бота и <li>username</li> пользователя, которому нужно отправлять уведомления
